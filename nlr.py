...
class NLRNet(nn.Cell):
    def __init__(self, dataset='gf2'):
        ...
        self.conv_input = nn.Conv2d(in_channels=9, out_channels=64, kernel_size=7, stride=1, pad_mode='pad',padding=3, has_bias=False)
        ...
        self.conv_mid = nn.Conv2d(in_channels=64, out_channels=64, kernel_size=3, stride=1, pad_mode='pad',padding=1, has_bias=False)
